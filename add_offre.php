        ...
        <div class="row">
            <div class="col-md-3">
                <div class="contact-info" style="text-align: center;">
                    ...
                    <h2>Here you can add an Offre!</h2>
                    <h4>An offre is described by a title and a description the date of creation and who created it is added automatically!</h4>
                </div>
            </div>
            <div class="col-md-9">
                <form class="contact-form" action="action/add_offre_action.php" method="POST" enctype="multipart/form-data">

                    <div class="form-group">
                        <label class="control-label col-sm-2" for="title">Title:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" placeholder="Enter First Name" name="title">
                        </div>
                    </div>
                    <div class="form-group">
